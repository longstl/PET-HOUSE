...
<div class="text col-8 mr-lg-6">
    <h1>Verify Your Email<br>
        Verify was sent to your email. please confirm.</h1><br><br>
    <<input type="button" value="Back to Site" class="btn btn-dark mx-auto d-block mt-lg-5 col-2" id="btnHome" role="button"
...
<style>
    ...
    * *:before, * *:after {
    ...
    .head-group .ear .ear-left, .head-group .ear .ear-right {
    ...
    .head-group .face .eyes .eye-left, .head-group .face .eyes .eye-right {
        width: 32px;
        height: 32px;
        border-radius: 50%;
    ...
    .head-group .face .eyes .eye-left .pupil, .head-group .face .eyes .eye-right .pupil {
    ...
    .head-group .face .eyes .eye-left .pupil:after, .head-group .face .eyes .eye-right .pupil:after {
        background-color: #fff;
        border-radius: 50%;
        width: 10px;
        height: 10px;
    ...
    .plant-group .plant .leaf:nth-of-type(1), .plant-group .plant .leaf:nth-of-type(2) {
        transform: rotate(-45deg);
    }
    .plant-group .plant .leaf:nth-of-type(4), .plant-group .plant .leaf:nth-of-type(5) {
        transform: rotate(45deg);
        left: 8px;
    }
    .plant-group .plant .leaf:nth-of-type(1), .plant-group .plant .leaf:nth-of-type(5) {
        bottom: -3px;
    }
    ...
    .plant-group .plant .leaf:nth-of-type(2), .plant-group .plant .leaf:nth-of-type(4) {
        bottom: 25px;
    }
    .shapes {
        width: 50%;
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
<script src="/js/auto_redirect.js" type="text/javascript" ></script>
</html>