...
<!-- Footer -->
<footer class="page-footer font-small mdb-color pt-4 bg-dark" style="background-color: #343A40; margin-top: 10px;">
                ...
                <div class="text-center text-md-right">
                    <ul class="list-unstyled list-inline">
                        <li class="list-inline-item">
                            <a class="btn-floating btn-sm rgba-white-slight mx-1" href="#" style="color: white">
