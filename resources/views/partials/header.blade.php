    ...
    <div class="container"><a class="navbar-brand" href="#page-top"><a
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="nav navbar-nav ml-auto text-uppercase">
                ...
                <li class="nav-item" role="presentation"><a style="color: black" class="nav-link js-scroll-trigger" href="/accessories">SHOP ACCESSORIES</a></li>
                <li class="nav-item" role="presentation"><a style="color: black" class="nav-link js-scroll-trigger" href="/foodpet">FOOD FOR PET</a></li>
