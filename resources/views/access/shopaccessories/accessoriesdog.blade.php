...
@section('content')
    ...
    <div class="bread-bar bg-grey">
        ...
        <br>
        <center><h2 class="nm-divider-title medium">Accessories</h2></center>
        <br>
    <div class="nm-divider separator_align_center col-12 ">
        <form class="form-inline" action="{{route('accessories')}}" method="GET"
...
@section('extra-js')
    ...
    `;
            ...
            <li class="page-item ${res.current_page === i ? 'active' : ''}">
                <a href="/accessories?page=${i}&min=${price[0]}&max=${price[1]}" class="page-link">${i}</a>
            </li>
        `;
            }
    ...
    `;
        ...
        function generateBlockRsSearch(id, title, img, price) {
            ...
            output += '<a href="/detailaccessories/' + id + '"><img src="' + img + '" style="height: 250px;" alt=""></a>';
