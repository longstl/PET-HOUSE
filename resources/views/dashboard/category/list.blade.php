@extends('dashboard.layout.masteradminlayout', [
   'page_title'=>'List Category | PET HOUSE Admin Page',
                        ...
                        <div class="row">
                            ...
                            @else
                                <div class="alert alert-info">There are currently no product categories. Please click<a
                                            href="/dashboard/category/create" title="Thêm mới sản phẩm" class="btn-link">come in</a> to create a new.
                                </div>
                            @endif
                        </div>
                        <div class="row">
    ...
    <script>
        ...
        (function () {
            ...
            document.getElementById('btn-del-checked').onclick = function () {
                ...
                req.open('GET', '/api/categories?' + 'ids=' + idsToDelete);
