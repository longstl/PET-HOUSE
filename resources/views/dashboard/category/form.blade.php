...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group label-floating is-empty{{$errors->has('description')?' has-error':''}}">
                                        <label class="control-label"></label>
                                        <textarea type="text" name="description" class="form-control{{$errors->has('description')?' error':''}}" id="category-form-ckeditor"></textarea>
                                        <span class="material-input"></span></div>
                                </div>
                            </div>
                            <div class="row">
    ...
    <script>
        CKEDITOR.replace( 'category-form-ckeditor' );
    </script>
@endsection