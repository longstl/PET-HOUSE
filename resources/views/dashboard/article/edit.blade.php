@extends('dashboard.layout.masteradminlayout', [
     'page_title' => 'Edit Article | PET HOUSE Admin Page',
...
@section('content')
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group label-floating is-empty">
                                        <label class="control-label"></label>
                                        <textarea type="text" name="content" class="form-control" id="article-edit-ckeditor">{{$obj->content}}</textarea>
                                        <span class="material-input"></span></div>
                                </div>
                            </div>
                            <div class="row">
    ...
    <script>
        CKEDITOR.replace( 'article-edit-ckeditor' );
    </script>
@endsection