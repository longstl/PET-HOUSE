@extends('dashboard.layout.masteradminlayout', [
   'page_title'=>'Danh sách danh mục sản phẩm | Seafashion Admin Page',
                        ...
                        <div class="row">
                                        ...
                                        @foreach($list_obj as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <a href="{{$item->id}}" class="btn btn-simple btn-danger btn-icon remove btn-delete-article"><i
                            ...
                            @else
                                <div class="alert alert-info">Hiện tại không có danh mục sản phẩm. Vui lòng click <a
                                            href="/dashboard/article/create" title="Thêm mới sản phẩm" class="btn-link">vào đây</a> để tạo mới.
                                </div>
                            @endif
                        </div>
                        <div class="row">
