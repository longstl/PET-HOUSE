...
class ProductTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('products')->insert([
            ...
            [
                'title' => 'Seal Point Persian kitten 3 weeks old',
                'description' => 'Seal point male. Born on July 18th. Take home day after September 18th, with shots, deworming and health certificate. Grown around kids and hand held. Live in a wonderful clean home and are well taken care of. Parents are CFA registered, FIV/FELV tested negative, no PKD illness in their generation. Breeding rights are extra',
                'images' => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmHPGa8blRTiGO4ogx-p3t52oxaq52fy8vpDTj_bzhrcVZVedzEQ',
                'categoryId' => '2',
                'price' => 11,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
